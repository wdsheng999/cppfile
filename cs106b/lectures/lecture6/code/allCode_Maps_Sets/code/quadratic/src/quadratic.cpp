...
int main() {
    ...
    while (true) {
        line = getLine("Please enter the coefficient for the x^2 term ('a'): ");
        a = stringToDouble(line);

        line = getLine("Please enter the coefficient for the x term ('b'): ");
        b = stringToDouble(line);

        line = getLine("Please enter the coefficient for the constant term ('c'): ");
        c = stringToDouble(line);
